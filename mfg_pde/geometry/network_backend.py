...
class AbstractNetworkBackend(ABC):
    ...
    @abstractmethod
    def add_edges(self, graph: Any, edges: List[Tuple[int, int]], weights: Optional[np.ndarray] = None) -> Any:
        """Add edges to graph."""
        pass
...
class NetworkBackendManager:
    ...
    def choose_backend(self, 
                      ...
                      force_backend: Optional[NetworkBackendType] = None) -> NetworkBackendType:
        """
        ...
        operation_preferences = {
            OperationType.LARGE_SCALE: [NetworkBackendType.NETWORKIT, NetworkBackendType.IGRAPH],
            OperationType.VISUALIZATION: [NetworkBackendType.IGRAPH, NetworkBackendType.NETWORKX],
            OperationType.ALGORITHMS: [NetworkBackendType.NETWORKX, NetworkBackendType.IGRAPH],
            OperationType.SHORTEST_PATHS: [NetworkBackendType.NETWORKIT, NetworkBackendType.IGRAPH],
            OperationType.CENTRALITY: [NetworkBackendType.NETWORKIT, NetworkBackendType.IGRAPH],
            OperationType.COMMUNITY: [NetworkBackendType.IGRAPH, NetworkBackendType.NETWORKX]
        }
    ...
    def create_optimized_graph(self, 
                              num_nodes: int,
                              operation_type: OperationType = OperationType.GENERAL,
                              force_backend: Optional[NetworkBackendType] = None,
                              **kwargs) -> Tuple[Any, NetworkBackendType]:
        """
...
def get_backend_manager(preferred_backend: NetworkBackendType = NetworkBackendType.IGRAPH) -> NetworkBackendManager:

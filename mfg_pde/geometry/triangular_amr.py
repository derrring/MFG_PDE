...
class TriangularAMRMesh:
    ...
    def _estimate_triangle_error(self, triangle: TriangleElement, 
...
def create_triangular_amr_mesh(mesh_data: MeshData,
                             error_threshold: float = 1e-4,
                             max_levels: int = 5,
                             backend: Optional[BaseBackend] = None) -> TriangularAMRMesh:
    """

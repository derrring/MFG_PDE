...
class GFDMConfig:
    ...
    def accurate(cls) -> 'GFDMConfig':
        """Create configuration optimized for accuracy."""
        return cls(delta=0.05, taylor_order=3, weight_function="wendland", use_qp_constraints=True)
...
class FPConfig:
    ...
    def accurate(cls) -> 'FPConfig':
        """Create configuration optimized for accuracy."""
        return cls(
            particle=ParticleConfig.accurate(),
...
def extract_legacy_parameters(config: MFGSolverConfig, **kwargs) -> Dict[str, Any]:
    ...
    if 'max_iterations' in kwargs:
        ...
        warnings.warn("Parameter 'Niter_max' is deprecated. Use configuration objects instead.",
    ...
    if 'tolerance' in kwargs:
        ...
        warnings.warn("Parameter 'l2errBoundPicard' is deprecated. Use configuration objects instead.",
                     DeprecationWarning, stacklevel=3)
    ...
    if 'max_newton_iterations' in kwargs:
        ...
        warnings.warn("Parameter 'NiterNewton' is deprecated. Use configuration objects instead.",
                     DeprecationWarning, stacklevel=3)
    ...
    if 'newton_tolerance' in kwargs:
        ...
        warnings.warn("Parameter 'l2errBoundNewton' is deprecated. Use configuration objects instead.",
                     DeprecationWarning, stacklevel=3)

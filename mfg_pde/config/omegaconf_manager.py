...
class OmegaConfManager:
    ...
    def create_parameter_sweep(self, base_config: DictConfig, 
                             sweep_params: Dict[str, List[Any]]) -> List[DictConfig]:
        """
...
def create_parameter_sweep_configs(lambda_values: List[float], 
                                 init_types: List[str]) -> List[DictConfig]:

...
from .jax_utils import (
    ensure_jax_available, to_device, from_device,
    finite_difference_1d, finite_difference_2d, 
    apply_boundary_conditions, tridiagonal_solve,
    compute_hamiltonian, compute_optimal_control,
    compute_convergence_error, mass_conservation_constraint
)
...
class JAXMFGSolver:
    ...
    def solve(self) -> Dict[str, Any]:
        ...
        print(f"✅ JAX solve completed in {self.solve_time:.2f}s (compile: {self.compile_time:.2f}s)")
    ...
    @jit
    def _check_convergence_kernel(self, U_new: jnp.ndarray, U_old: jnp.ndarray,
    ...
    def compute_sensitivity(self, parameter_name: str, 
                          perturbation: float = 1e-6) -> Dict[str, Any]:
        """

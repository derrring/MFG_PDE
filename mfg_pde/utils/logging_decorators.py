...
from .logging import get_logger, log_solver_start, log_solver_completion, LoggedOperation
            ...
            try:
                ...
                if log_result:
                    ...
                    log_solver_completion(
                        logger, solver_name, iterations, final_error, 
                        execution_time, converged
                    )

...
class SolverResult:
    ...
    def __post_init__(self):
        ...
        if self.iterations != len(self.error_history_U):
            ...
            if self.iterations <= len(self.error_history_U):
                ...
                raise ValueError(f"Iterations ({self.iterations}) exceeds error history length ({len(self.error_history_U)})")
    ...
    def __getitem__(self, index):
        ...
        tuple_representation = (self.U, self.M, self.iterations, self.error_history_U, self.error_history_M)
    ...
    def __repr__(self) -> str:
        ...
        return (f"SolverResult({self.solver_name}: {convergence_status} "

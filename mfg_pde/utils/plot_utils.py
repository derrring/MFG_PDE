...
def plot_convergence(
    iterations_run, l2disturel_u, l2disturel_m, solver_name="Solver"
):  # Modified to pass relative errors directly
...
def plot_results(
    problem, u, m, solver_name="Solver", prefix=None
):  # Modified to not require prefix
    ...
    )  # Adjusted ylim for better view, added checks for empty mtot
    plt.grid(True)

...
class MFGDataFrame:
    ...
    def __init__(self, data: Optional[Union[pl.DataFrame, Dict[str, Any], List[Dict[str, Any]], np.ndarray]] = None):
        """
...
class MFGParameterSweepAnalyzer:
    ...
    def analyze_parameter_effects(self, df: MFGDataFrame, 
                                parameter_cols: List[str],
                                metric_cols: List[str]) -> pl.DataFrame:
        """
    ...
    def compute_correlation_matrix(self, df: MFGDataFrame, 
    ...
    def find_optimal_parameters(self, df: MFGDataFrame,
...
class MFGTimeSeriesAnalyzer:
    ...
    def analyze_convergence_rate(self, df: MFGDataFrame, 
                                error_column: str = "error") -> Dict[str, float]:
        """
    ...
    def detect_convergence_plateau(self, df: MFGDataFrame,
                                  error_column: str = "error",
                                  window_size: int = 10,
                                  plateau_threshold: float = 1e-8) -> Optional[int]:
        """

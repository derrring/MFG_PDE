...
def with_progress_monitoring(
    ...
    def decorator(solve_method):
        ...
        def wrapper(self, *args, **kwargs):
            ...
            timer_context = SolverTimer(f"{solver_name} Solve", verbose=show_timing and verbose) if show_timing else None
...
def update_solver_progress(progress_tracker: Optional[IterationProgress],
                          iteration: int,
...
def format_solver_summary(solver_name: str,
                         iterations: int,
                         final_error: Optional[float] = None,
                         execution_time: Optional[float] = None,
                         converged: bool = True) -> str:
    """

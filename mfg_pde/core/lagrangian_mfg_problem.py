...
class LagrangianMFGProblem:
    ...
    def evaluate_lagrangian(
        self, t: float, x: Union[float, NDArray], v: Union[float, NDArray], 
    ...
    def compute_euler_lagrange_residual(
        self, trajectory: NDArray, velocity: NDArray, acceleration: NDArray,
    ...
    def create_compatible_mfg_problem(self):
        ...
        # Create MFG problem
        return MFGProblem(
            xmin=self.xmin, xmax=self.xmax, Nx=self.Nx,
            T=self.T, Nt=self.Nt,
            sigma=self.sigma,
    ...
    def get_problem_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "components": {
                ...
                "has_constraints": (
                    self.components.state_constraints is not None or
                    self.components.velocity_constraints is not None
                ),
...
def create_quadratic_lagrangian_mfg(
    xmin: float = 0.0, xmax: float = 1.0, Nx: int = 51,
    T: float = 1.0, Nt: int = 51,

...
def validate_solution_arrays(U: SolutionArray, M: SolutionArray, 
                            Nx: int, Nt: int) -> bool:
    """
...
def format_mathematical_summary(U: SolutionArray, M: SolutionArray,
                               problem_params: ParameterDict) -> str:
    """

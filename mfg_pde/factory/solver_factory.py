...
from ..config.solver_config import (
    MFGSolverConfig, PicardConfig, HJBConfig, FPConfig, 
    NewtonConfig, GFDMConfig, ParticleConfig,
...
from ..alg.enhanced_particle_collocation_solver import MonitoredParticleCollocationSolver
...
class SolverFactory:
    ...
    def create_solver(
        ...
        custom_config: Optional[MFGSolverConfig] = None,
        **kwargs
    ) -> Union[ConfigAwareFixedPointIterator, MonitoredParticleCollocationSolver, SilentAdaptiveParticleCollocationSolver]:
        """
            ...
            return MFGSolverConfig(
                ...
                fp=FPConfig(
                    particle=ParticleConfig(
                        num_particles=3000, kde_bandwidth="scott", 
                        normalize_output=True, boundary_handling="absorbing"
                    )
                ),
    ...
    def _create_fixed_point_solver(
        ...
        **kwargs
        ...
        config_keys = {
            'max_picard_iterations', 'picard_tolerance', 'max_newton_iterations',
            'newton_tolerance', 'return_structured', 'warm_start', 'num_particles', 'delta'
        }
...
def create_research_solver(
    problem: "MFGProblem",
    solver_type: SolverType = "monitored_particle",
    **kwargs
) -> Union[ConfigAwareFixedPointIterator, MonitoredParticleCollocationSolver, SilentAdaptiveParticleCollocationSolver]:
    """

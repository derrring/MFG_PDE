...
class MFGSystemBuilder:
    ...
    def constraint(self, expr: str, variables: List[str] = None) -> 'MFGSystemBuilder':
        ...
        self.constraints.append(MathematicalExpression(
            expr, variables, self.parameters
        ))
        return self
    ...
    def domain(self, xmin: float, xmax: float, tmax: float, 
               nx: int = 100, nt: int = 50) -> 'MFGSystemBuilder':
        """Define computational domain."""
        self.domain_info = {
            "xmin": xmin, "xmax": xmax, "tmax": tmax,
            "nx": nx, "nt": nt
        }
        return self

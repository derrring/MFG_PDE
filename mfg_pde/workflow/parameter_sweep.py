...
class ParameterSweep:
    ...
    def _execute_single(self, function: Callable, params: Dict[str, Any], 
                       run_id: int, **kwargs) -> Dict[str, Any]:
    ...
    def _analyze_parameter_effects(self, df: pd.DataFrame) -> Dict[str, Any]:
        ...
        result_columns = [col for col in numeric_columns 
...
def create_adaptive_sweep(parameters: Dict[str, List], 
                         objective_function: Callable,
                         n_initial: int = 10,
                         n_iterations: int = 50) -> ParameterSweep:
    """

...
class Workflow:
    ...
    def execute(self, max_workers: Optional[int] = None, 
                save_results: bool = True) -> WorkflowResult:
        """
...
class WorkflowManager:
    ...
    def _create_example_workflows(self):
        ...
        workflow1.add_step("solve_problem", example_solve, 
                          inputs={'sigma': 0.5, 'Nx': 20, 'Nt': 10})
...
# Export main classes
__all__ = ['Workflow', 'WorkflowManager', 'WorkflowResult', 'WorkflowStep', 'WorkflowStatus', 'StepStatus']
...
# Import stencil functions from dedicated module
from .fp_fdm_stencils import (
    add_boundary_no_flux_entries as _add_boundary_no_flux_entries,
)
from .fp_fdm_stencils import (
    add_boundary_no_flux_entries_conservative as _add_boundary_no_flux_entries_conservative,
)
from .fp_fdm_stencils import (
    add_interior_entries as _add_interior_entries,
)
from .fp_fdm_stencils import (
    add_interior_entries_conservative as _add_interior_entries_conservative,
)
from .fp_fdm_stencils import (
    is_boundary_point as _is_boundary_point,
)
...
# Note: Stencil building functions moved to fp_fdm_stencils.py

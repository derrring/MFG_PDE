...
This module provides the mathematical operations used in FDM discretization:
- Stencil construction for interior and boundary points
- Diffusion operator discretization (Laplacian)
- Advection operator discretization (upwind schemes)

The operators are used by fp_fdm.py to build the sparse system matrix.

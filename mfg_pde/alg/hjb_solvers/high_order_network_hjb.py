...
class HighOrderNetworkHJBSolver(NetworkHJBSolver):
    ...
    def _network_upwind_step(self, u_next: np.ndarray, m: np.ndarray, 
    ...
    def _lax_friedrichs_step(self, u_next: np.ndarray, m: np.ndarray,
                           t: float, dt: float) -> np.ndarray:
    ...
    def _godunov_step(self, u_next: np.ndarray, m: np.ndarray,
                     t: float, dt: float) -> np.ndarray:
    ...
    def _solve_network_riemann_problem(self, node_i: int, node_j: int,
                                     u: np.ndarray, m: np.ndarray, t: float) -> float:
    ...
    def _compute_upwind_hamiltonian(self, node: int, neighbors: List[int],
...
def create_high_order_network_hjb_solver(problem: "NetworkMFGProblem",
                                        scheme: str = "network_upwind",
                                        **kwargs) -> HighOrderNetworkHJBSolver:
    """

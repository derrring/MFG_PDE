        ...
        **kwargs
        ...
        for iiter in range(solve_config.picard.max_iterations):
            ...
            self.l2distu_rel[iiter] = (
                self.l2distu_abs[iiter] / norm_U if norm_U > 1e-12 else self.l2distu_abs[iiter]
            )
            ...
            self.l2distm_rel[iiter] = (
                self.l2distm_abs[iiter] / norm_M if norm_M > 1e-12 else self.l2distm_abs[iiter]
            )
            ...
            if (iiter + 1) % solve_config.picard.convergence_check_frequency == 0:
                if (self.l2distu_rel[iiter] < solve_config.picard.tolerance and
                    self.l2distm_rel[iiter] < solve_config.picard.tolerance):
        ...
        if not convergence_achieved and solve_config.picard.verbose:
            ...
            final_error = max(self.l2distu_rel[self.iterations_run - 1],

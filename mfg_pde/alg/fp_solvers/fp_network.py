...
class NetworkFPSolver(BaseFPSolver):
    ...
    def solve_fp_system(self,
                       ...
                       U_solution_for_drift: np.ndarray) -> np.ndarray:
        """
    ...
    def _compute_edge_flow(self, node_from: int, node_to: int, 
                          m: np.ndarray, u: np.ndarray, t: float) -> float:
...
class NetworkFlowFPSolver(NetworkFPSolver):
    ...
    def _compute_directed_edge_flow(self, node_from: int, node_to: int,
                                   m: np.ndarray, u: np.ndarray, t: float) -> float:
...
def create_network_fp_solver(problem: "NetworkMFGProblem",
                            solver_type: str = "explicit",
                            **kwargs) -> NetworkFPSolver:
    """

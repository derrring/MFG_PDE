...
class AMREnhancedSolver:
    ...
    def _solve_on_current_mesh(self, max_iterations: int, tolerance: float,
                              verbose: bool, **kwargs) -> Dict[str, Any]:
    ...
    def _adapt_mesh_if_needed(self, solution_result: Dict[str, Any], 
    ...
    def _transfer_solution_to_new_mesh(self, solution_result: Dict[str, Any],
    ...
    def _collect_final_results(self, solution_result: Dict[str, Any], 
                              verbose: bool) -> Dict[str, Any]:
        ...
        final_result = {
            **solution_result,  # Include all base solver results
            ...
            'amr_converged': len(self.adaptation_history) > 0 and 
                           self.adaptation_history[-1].get('total_refined', 0) == 0,
        }
...
def create_amr_enhanced_solver(base_solver: "MFGSolver",
                              dimension: int = None,
                              amr_config: Optional[Dict[str, Any]] = None) -> AMREnhancedSolver:
    """
    ...
    """
    from ..geometry.one_dimensional_amr import create_1d_amr_mesh, OneDimensionalErrorEstimator

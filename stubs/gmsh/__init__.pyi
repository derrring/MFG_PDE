...
class ModelModule:
    ...
    class MeshModule:
        ...
        def getElements(self, dim: int = -1, tag: int = -1) -> tuple[Any, Any, Any]: ...
    ...
    def getPhysicalGroupsForEntity(self, dim: int, tag: int) -> list[int]: ...
    def getEntitiesForPhysicalGroup(self, dim: int, tag: int) -> list[int]: ...

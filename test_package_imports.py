...
def test_core_imports():
    ...
    try:
        from mfg_pde import MFGProblem, ExampleMFGProblem, BoundaryConditions
...
def test_hjb_solver_imports():
    ...
    try:
        from mfg_pde.alg.hjb_solvers import (
            BaseHJBSolver, FdmHJBSolver, GFDMHJBSolver,
            SmartQPGFDMHJBSolver, TunedSmartQPGFDMHJBSolver
        )
...
def test_fp_solver_imports():
    ...
    try:
        from mfg_pde.alg.fp_solvers import (
            BaseFPSolver, FdmFPSolver, ParticleFPSolver
        )
...
def test_production_solvers():
    ...
    try:
        ...
        problem = ExampleMFGProblem(xmin=0.0, xmax=1.0, Nx=10, T=0.5, Nt=10, 

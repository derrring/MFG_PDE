...
try:
    from mfgarchon.utils.polars_integration import (
        POLARS_AVAILABLE,
        MFGDataFrame,
...
class MFGAnalyticsEngine:
    ...
    def _export_solution_data(
        ...
        from mfgarchon.utils.polars_integration import create_mfg_dataframe
...
<body>
    ...
    <div class="summary">
        ...
        <p>Generated using the MFGarchon Advanced Analytics Engine with Polars data processing and Plotly/Bokeh visualizations.</p>
    </div>
"""
...
"""
    ...
    <hr>
    <footer>
        <p><em>Generated by MFGarchon Advanced Analytics Engine</em></p>

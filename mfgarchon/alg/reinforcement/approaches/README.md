...
```python
# mfgarchon/alg/reinforcement/approaches/value_based/base.py
...
```python
# mfgarchon/alg/reinforcement/algorithms/nash_q.py
...
**Algorithms are currently implemented directly in** `mfgarchon/alg/reinforcement/algorithms/`:

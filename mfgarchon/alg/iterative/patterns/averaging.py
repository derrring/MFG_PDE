...
from mfgarchon.alg.iterative.patterns.picard import FixedPointIteratorBase
from mfgarchon.alg.iterative.schedules import get_schedule

if TYPE_CHECKING:
    from collections.abc import Callable

    from mfgarchon.alg.iterative.convergence import ConvergenceResult

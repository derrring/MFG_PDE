...
Migration Note (Issue #628):
    This module was moved from `mfgarchon.solvers.extensions.multi_population.fixed_point`
...
from mfgarchon.alg.iterative.base import BaseIterativeSolver
from mfgarchon.alg.iterative.fixed_point import FixedPointSolver

if TYPE_CHECKING:
    from numpy.typing import NDArray

    from mfgarchon.extensions.multi_population import MultiPopulationMFGProtocol
    from mfgarchon.types import ConvergenceInfo, SolutionArray, SpatialTemporalState
...
class MultiPopulationFixedPointSolver(BaseIterativeSolver):
    ...
    Example:
        ...
        >>> from mfgarchon.alg.iterative import MultiPopulationFixedPointSolver
        >>>

...
Migration Note (Issue #628):
    This module was moved from `mfgarchon.solvers.base` to consolidate
...
from mfgarchon.types import ConvergenceInfo, MFGProblem, MFGResult, SpatialTemporalState
...
if TYPE_CHECKING:
    ...
    from mfgarchon.utils.convergence import ConvergenceChecker

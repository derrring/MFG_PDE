"""
Parameter Migration Utilities for MFGarchon Package
...
class ParameterMigrator:
    ...
    def _register_standard_mappings(self) -> None:
        """Register all standard parameter mappings for MFGarchon."""
...
def get_parameter_migration_guide() -> str:
    ...
    guide = """
MFGarchon Parameter Migration Guide
================================
...
For automatic migration, use the @migrate_parameters decorator:
    ...
    from mfgarchon.utils.parameter_migration import migrate_parameters

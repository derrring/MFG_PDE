...
# Use mfgarchon.utils.convergence.convergence_monitors instead, which provides
...
def validate_solver_output(
    ...
    *,
    ...
    """
    from mfgarchon.utils.validation.arrays import validate_finite, validate_non_negative

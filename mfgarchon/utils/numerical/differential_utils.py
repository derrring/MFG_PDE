...
- mfgarchon.utils.numerical.grid_operators for grid-based operators

This module is kept for backward compatibility and will be removed in v1.0.

Migration Guide:
    # Old: from mfgarchon.utils.numerical.differential_utils import gradient_fd
    # New: from scipy.optimize import approx_fprime
    #      grad = approx_fprime(x, f, epsilon=1e-7)

    # Old: from mfgarchon.utils.numerical.differential_utils import gradient_grid_nd
    # New: from mfgarchon.utils.numerical.tensor_calculus import gradient_simple

    # Old: from mfgarchon.utils.numerical.differential_utils import compute_dH_dp
...
def gradient_grid_nd(
    ...
    """
    DEPRECATED: Use mfgarchon.utils.numerical.grid_operators.gradient_simple instead.
    """
    warnings.warn(
        "gradient_grid_nd is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.gradient_simple instead.",
        DeprecationWarning,
        stacklevel=2,
    )
    from mfgarchon.utils.numerical.tensor_calculus import gradient_simple

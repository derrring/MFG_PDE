...
.. deprecated:: 0.18.0
    ...
    Migration Guide::
        ...
        from mfgarchon.utils.numerical.grid_operators import GradientOperator
...
def gradient(
    ...
    """
    DEPRECATED: Use mfgarchon.utils.numerical.tensor_calculus.gradient instead.
    """
    warnings.warn(
        "grid_operators.gradient is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.gradient instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def gradient_simple(
    ...
    """
    DEPRECATED: Use mfgarchon.utils.numerical.tensor_calculus.gradient_simple instead.
    """
    warnings.warn(
        "grid_operators.gradient_simple is deprecated. "
        "Use mfgarchon.utils.numerical.tensor_calculus.gradient_simple instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def laplacian(
    ...
    """
    DEPRECATED: Use mfgarchon.utils.numerical.tensor_calculus.laplacian instead.
    """
    warnings.warn(
        "grid_operators.laplacian is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.laplacian instead.",
        DeprecationWarning,
        stacklevel=2,
    )
...
class GradientOperator:
    """
    DEPRECATED: Use mfgarchon.utils.numerical.tensor_calculus.gradient() directly.
    ...
    def __init__(
        ...
        warnings.warn(
            "GradientOperator is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.gradient() directly.",
            DeprecationWarning,
            stacklevel=2,
        )
        self.scheme = scheme
...
if __name__ == "__main__":
    ...
    print("Use mfgarchon.utils.numerical.tensor_calculus instead.")

...
.. deprecated:: 0.18.0
    ...
    Migration Guide::
        ...
        # Old
        from mfgarchon.utils.numerical.tensor_operators import (
...
from mfgarchon.utils.numerical.tensor_calculus import diffusion as _diffusion
...
def divergence_tensor_diffusion_2d(
    ...
    """
    DEPRECATED: Use mfgarchon.utils.numerical.tensor_calculus.diffusion instead.
    ...
    """
    warnings.warn(
        "divergence_tensor_diffusion_2d is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.diffusion instead. Will be removed in v1.0.0.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def divergence_diagonal_diffusion_2d(
    ...
    warnings.warn(
        ...
        "Use mfgarchon.utils.numerical.tensor_calculus.diffusion instead. Will be removed in v1.0.0.",
        DeprecationWarning,
        stacklevel=2,
    )
...
def divergence_tensor_diffusion_nd(
    ...
    """
    warnings.warn(
        "divergence_tensor_diffusion_nd is deprecated. Use mfgarchon.utils.numerical.tensor_calculus.diffusion instead. Will be removed in v1.0.0.",
        DeprecationWarning,
        stacklevel=2,
    )
...
if __name__ == "__main__":
    ...
    print("Use mfgarchon.utils.numerical.tensor_calculus.diffusion instead.")

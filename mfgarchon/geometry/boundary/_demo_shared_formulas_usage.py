...
Run: python mfgarchon/geometry/boundary/_demo_shared_formulas_usage.py
"""
...
from mfgarchon.geometry.boundary.applicator_base import BaseStructuredApplicator
from mfgarchon.geometry.boundary.applicator_fdm import GhostCellConfig
from mfgarchon.geometry.boundary.conditions import BoundaryConditions  # noqa: TC001 (used at runtime)

...
def smooth_walls_morphological(
    ...
    Example:
        >>> from mfgarchon.geometry.graph import CellularAutomataGenerator
        >>> from mfgarchon.geometry.graph.maze_utils import smooth_walls_morphological
        >>>
...
def connect_regions_adaptive(
    ...
    Example:
        >>> from mfgarchon.geometry.graph import CellularAutomataGenerator
        >>> from mfgarchon.geometry.graph.maze_utils import connect_regions_adaptive
        >>>
...
def analyze_maze_connectivity(maze: NDArray) -> dict:
    ...
    Example:
        >>> from mfgarchon.geometry.graph.maze_utils import analyze_maze_connectivity
        >>>

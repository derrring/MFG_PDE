...
Migration Guide:
    OLD (callable wrappers):
        >>> from mfgarchon.geometry.operators import create_divergence_operator
        >>> div_op = create_divergence_operator(spacings, field_shape, bc)
        >>> div_F = div_op(F)  # Callable only

    NEW (LinearOperator classes):
        >>> from mfgarchon.geometry.operators import DivergenceOperator
...
def create_divergence_operator(
    ...
    """
    from mfgarchon.utils.numerical.tensor_calculus import divergence

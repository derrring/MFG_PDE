...
DEPRECATION NOTICE:
    This module has been graduated to MFGarchon (PR #189). After PR #189 merges,
    import from mfgarchon.geometry.implicit instead:

        from mfgarchon.geometry.implicit import Hyperrectangle, Hypersphere, DifferenceDomain

    This local copy will be removed once PR #189 is merged to MFGarchon main.

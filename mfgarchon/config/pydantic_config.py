"""
Legacy configuration classes for MFGarchon solvers.

NOTE: This module contains legacy configuration classes that have been superseded
by the canonical MFGSolverConfig in mfgarchon.config.core.

For new code, use:
    from mfgarchon.config.core import MFGSolverConfig, PicardConfig
...
New (recommended):
    from mfgarchon.config.core import MFGSolverConfig
...
from mfgarchon.config.core import MFGSolverConfig  # noqa: E402

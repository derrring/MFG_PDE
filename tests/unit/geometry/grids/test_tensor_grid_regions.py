...
class TestMarkRegionBasicFunctionality:
    ...
    def grid_2d(self):
        """Create 2D test grid."""
        return TensorProductGrid(dimension=2, bounds=[(0, 1), (0, 1)], Nx=[10, 10])
...
class TestBoundaryRegionMarking:
    ...
    def test_3d_boundary_naming(self):
        ...
        grid_3d = TensorProductGrid(dimension=3, bounds=[(0, 1)] * 3, Nx=[5, 5, 5])
    ...
    def test_high_dimensional_boundary_naming(self):
        ...
        grid_4d = TensorProductGrid(dimension=4, bounds=[(0, 1)] * 4, Nx=[3, 3, 3, 3])
...
class TestRegionMarkingUseCases:
    ...
    def test_mixed_boundary_conditions_setup(self):
        ...
        grid = TensorProductGrid(dimension=2, bounds=[(0, 10), (0, 5)], Nx=[100, 50])

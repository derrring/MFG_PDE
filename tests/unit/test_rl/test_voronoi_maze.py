...
class TestUnionFind:
    ...
    def test_initialization(self):
        ...
        from mfgarchon.geometry.graph.maze_voronoi import UnionFind
...
class TestIntegration:
    ...
    def test_comparison_with_recursive_division(self):
        ...
        from mfgarchon.alg.reinforcement.environments import RecursiveDivisionConfig, RecursiveDivisionGenerator

...
def create_final_plots(results, problem_params):
    ...
    if len(times) > 1:
        ...
        ax2.text(0.5, 0.9, f'Speedup: {speedup:.1f}x', transform=ax2.transAxes,
    ...
    plt.tight_layout()
    plt.savefig('/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/tests/method_comparisons/final_optimization_results.png', 

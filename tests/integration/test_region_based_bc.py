...
class TestRegionBasedBC1D:
    ...
    def test_basic_inlet_outlet_1d(self):
        ...
        geometry = TensorProductGrid(
            dimension=1, bounds=[(0, 10)], boundary_conditions=no_flux_bc(dimension=1), Nx_points=[101]
        )
    ...
    def test_boundary_vs_predicate_regions_1d(self):
        ...
        geometry = TensorProductGrid(
            dimension=1, bounds=[(0, 1)], boundary_conditions=no_flux_bc(dimension=1), Nx_points=[51]
        )
...
class TestRegionBasedBC2D:
    ...
    def test_corridor_flow_2d(self):
        ...
        geometry = TensorProductGrid(
            dimension=2, bounds=[(0, 2), (0, 1)], boundary_conditions=no_flux_bc(dimension=2), Nx_points=[41, 21]
        )
    ...
    def test_predicate_based_inlet_2d(self):
        ...
        geometry = TensorProductGrid(
            dimension=2, bounds=[(0, 1), (0, 1)], boundary_conditions=no_flux_bc(dimension=2), Nx_points=[21, 21]
        )
...
class TestRegionBasedBCPerformance:
    ...
    def test_region_lookup_overhead(self):
        ...
        geometry = TensorProductGrid(
            dimension=2, bounds=[(0, 1), (0, 1)], boundary_conditions=no_flux_bc(dimension=2), Nx_points=[101, 101]
        )

...
class TestMultiDimWorkflow2D:
    ...
    def test_complete_2d_poisson_problem(self):
        ...
        grid = TensorProductGrid(
            bounds=[(0.0, 1.0), (0.0, 1.0)], Nx_points=[31, 31], boundary_conditions=no_flux_bc(dimension=2)
        )
...
class TestMultiDimVisualization:
    ...
    def test_invalid_dimension_visualization(self):
        ...
        grid_1d = TensorProductGrid(bounds=[(0.0, 1.0)], Nx_points=[21], boundary_conditions=no_flux_bc(dimension=1))
...
class TestMemoryEfficiency:
    ...
    def test_2d_grid_memory_advantage(self):
        ...
        grid = TensorProductGrid(
            bounds=[(0.0, 10.0), (0.0, 10.0)], Nx_points=[100, 100], boundary_conditions=no_flux_bc(dimension=2)
        )

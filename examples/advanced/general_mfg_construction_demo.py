...
from mfg_pde.core.mfg_problem import MFGProblemBuilder, MFGComponents, MFGProblem
...
def main():
    ...
    try:
        ...
        for i, prob in enumerate(problems, 1):
            ...
            logger.info(f"   Custom components: H={info['has_custom_hamiltonian']}, V={info['has_custom_potential']}, "

...
from mfg_pde import (
    MFGProblem, create_solver, create_fast_solver, 
...
def demonstrate_simple_factory_usage():
    ...
    research_solver = create_research_solver(
        problem=problem,
        collocation_points=collocation_points
    )
...
def demonstrate_factory_benefits():
    ...
    solver2 = create_solver(
        problem, "monitored_particle", preset="fast", 
        collocation_points=collocation_points, num_particles=10000
    )

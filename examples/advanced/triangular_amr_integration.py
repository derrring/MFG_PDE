...
from mfg_pde.geometry import MeshData, Domain2D, MeshManager, MeshPipeline

# Import new triangular AMR
from mfg_pde.geometry.triangular_amr import (
...
Aspect Ratio: {stats['min_aspect_ratio']:.2f} - {stats['max_aspect_ratio']:.2f}"""
    ...
    ax.text(0.02, 0.98, text_stats, transform=ax.transAxes, 

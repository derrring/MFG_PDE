...
from mfg_pde.geometry import Domain2D, MeshPipeline, BoundaryManager
...
class MFGProblem2D(MFGProblem):
    ...
    def __init__(self,
        ...
        logger.info(f"Initialized 2D MFG problem: {self.num_nodes_2d} nodes, "
                   f"{self.num_elements_2d} elements")

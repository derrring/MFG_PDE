...
from mfg_pde import (
    MFGProblem, SolverFactory, create_solver, create_fast_solver, 
    create_accurate_solver, create_research_solver, create_monitored_solver
)
from mfg_pde.config import create_research_config, MFGSolverConfig
from mfg_pde.alg.hjb_solvers import HJBGFDMSolver
from mfg_pde.alg.fp_solvers import FPParticleSolver
from mfg_pde.alg import ConfigAwareFixedPointIterator, MonitoredParticleCollocationSolver, SilentAdaptiveParticleCollocationSolver
...
def test_parameter_overrides():
    ...
    try:
        ...
        if solver.num_particles == 7500 and solver.hjb_solver.newton_tolerance == 1e-7:
            ...
            print(f"  ⚠ Basic parameter override: unexpected values - particles={solver.num_particles}, tolerance={solver.hjb_solver.newton_tolerance}")
    ...
    try:
        ...
        if solver.num_particles == 6000 and solver.hjb_solver.newton_tolerance == 1e-9:
            ...
            print(f"  ⚠ Custom configuration: unexpected values - particles={solver.num_particles}, tolerance={solver.hjb_solver.newton_tolerance}")

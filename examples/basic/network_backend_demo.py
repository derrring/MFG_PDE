...
# MFG_PDE imports
from mfg_pde.geometry.network_backend import (
    get_backend_manager, NetworkBackendType, OperationType
)
from mfg_pde.geometry.network_geometry import (
    create_network, GridNetwork, RandomNetwork, ScaleFreeNetwork, NetworkType
)
...
def benchmark_backends():
    ...
    for network_type in network_types:
        ...
        for size in sizes:
            ...
            print(f"Backend: {backend_used:8s} | Time: {creation_time:.4f}s | "
                  f"Edges: {network_data.num_edges:4d}")
...
def show_backend_capabilities():
    ...
    for backend_type in [NetworkBackendType.NETWORKX, NetworkBackendType.IGRAPH, NetworkBackendType.NETWORKIT]:
        ...
        print(f"{backend_type.value:12} | {caps.max_recommended_nodes:>10,} | "

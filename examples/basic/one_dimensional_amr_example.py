...
from mfg_pde.geometry.one_dimensional_amr import (
    create_1d_amr_mesh,
...
def create_1d_amr_visualization(amr_mesh, solution_data, stats):
    ...
    try:
        ...
        scatter = ax1.scatter(positions, levels, c=levels, cmap='viridis', 
        ...
        ax4 = axes[1, 1]
        ax4.bar(grid_points, interval_widths, width=interval_widths*0.8, 

...
# MFG_PDE imports
from mfg_pde.core.network_mfg_problem import (
...
def analyze_and_visualize_results(problem: NetworkMFGProblem, 
                                 U: np.ndarray, 
                                 M: np.ndarray,
    ...
    fig_density = visualizer.plot_density_evolution(
        M, times, selected_nodes,
        title="Density Evolution: Corner vs Center Nodes",
        interactive=False
    )
    plt.show()
    ...
    fig_dashboard = visualizer.plot_network_statistics_dashboard(

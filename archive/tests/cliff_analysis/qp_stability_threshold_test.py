    ...
    for test_config in test_sequence:
        ...
        try:
            ...
            U_solution, M_solution, solve_info = solver.solve(
                Niter=12, l2errBound=1e-3, verbose=False  # Reduced for speed
            )
            ...
            if U_solution is not None and M_solution is not None:
                ...
                results[name] = {
                    ...
                    'arrays': {'mass_evolution': mass_evolution, 'tSpace': problem.tSpace, 'M_solution': M_solution},
                }
...
def create_stability_threshold_plots(results):
    ...
    plt.tight_layout()
    plt.savefig(
        '/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/qp_stability_threshold.png',
        dpi=150,
        bbox_inches='tight',
    )
    plt.show()

...
def demonstrate_kernel_bandwidth_collapse():
    ...
    scenarios = [
        ("Well-separated", particles_good),
        ("Clustered", particles_bad)
    ]
...
def create_stability_analysis_plots(particles_evolution):
    ...
    fig.suptitle('Numerical Stability Loss Mechanisms in Long-Time Simulations', 
    ...
    im1 = ax1.imshow(particle_matrix, aspect='auto', cmap='viridis', 
                     extent=[0, len(time_steps), 0, len(particle_matrix)])
    ...
    plt.tight_layout()
    plt.savefig('/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/stability_analysis.png', 

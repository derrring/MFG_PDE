...
def test_monotone_qp_comparison():
    ...
    problem = ExampleMFGProblem(xmin=0.0, xmax=1.0, Nx=30, T=0.3, Nt=12, sigma=0.3, coefCT=0.1)
    ...
    solver_standard = ParticleCollocationSolver(**solver_params, use_monotone_constraints=False)

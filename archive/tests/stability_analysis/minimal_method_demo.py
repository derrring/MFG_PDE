...
def demonstrate_qp_collocation_behavior():
    ...
    problem_params = {"xmin": 0.0, "xmax": 1.0, "Nx": 15, "T": 0.1, "Nt": 5, "sigma": 0.1, "coefCT": 0.005}
...
def create_minimal_demo_plots(problem, M_solution, U_solution, mass_evolution):
    ...
    plt.tight_layout()
    plt.savefig(
        '/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/minimal_demo.png',
        dpi=150,
        bbox_inches='tight',
    )
    plt.show()

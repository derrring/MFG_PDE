...
def analyze_mild_results(results, problem):
    ...
    # Mass conservation
    both_good_mass = (abs(hybrid['mass_change_percent']) < 5 and 
                     abs(qp['mass_change_percent']) < 5)
    if both_good_mass:
...
def create_mild_comparison_plots(results, problem):
    ...
    plt.tight_layout()
    plt.savefig('/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/tests/stability_analysis/mild_environment_comparison.png', 

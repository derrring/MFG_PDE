...
class OptimizedGFDMHJBSolver(GFDMHJBSolver):
    ...
    def _needs_qp_constraints(self, unconstrained_solution: np.ndarray, point_idx: int) -> bool:
        """
    ...
    def solve_hjb_system(
        ...
        try:
            ...
            result = super().solve_hjb_system(M_density_evolution_from_FP, U_final_condition_at_T, U_from_prev_picard)

...
def test_method_comparison():
    ...
    try:
        ...
        print(f"✓ Hybrid completed: {hybrid_time:.1f}s, mass error: {mass_error_hybrid:.2f}%, iterations: {iterations_hybrid}")
    ...
    try:
        ...
        print(f"✓ QP-Collocation completed: {qp_time:.1f}s, mass error: {mass_error_qp:.2f}%, iterations: {info_qp.get('iterations', 0)}")
...
def create_comparison_plots(results, problem_params):
    ...
    plt.tight_layout()
    plt.savefig('/Users/zvezda/Library/CloudStorage/OneDrive-Personal/code/MFG_PDE/tests/method_comparisons/fixed_method_comparison.png', 
